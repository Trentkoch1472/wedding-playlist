...
import DocLayout, { H2, P, Lead, MailLink } from './DocLayout';

export default function Privacy() {
  return (
    <DocLayout title="Privacy Policy" updated="Last updated: August 7, 2026">
      ...
      <H2>Contact</H2>
      <P>
        Questions about this policy or your data: <MailLink address="privacy@swipedj.app" />
      </P>
